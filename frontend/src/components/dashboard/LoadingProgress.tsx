    ...
    <div className="space-y-4 mt-4">
      ...
      >
        <div className="flex justify-between items-center mb-3">
          <span className="text-sm flex items-center gap-2" style={{ color: "rgba(255,255,255,0.8)" }}>
            <svg className="w-4 h-4 animate-spin" style={{ color: "#9D50FF" }} fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
            </svg>
            {message}
          </span>
          <span className="text-xs font-semibold tabular-nums" style={{ color: "#9D50FF" }}>{progress}%</span>
        </div>

        <div className="h-[3px] rounded-full overflow-hidden" style={{ background: "rgba(157,80,255,0.12)" }}>
          <motion.div
        ...
        {/* Warning inline */}
        <div className="mt-3 flex items-start gap-2 text-xs" style={{ color: "rgba(255,200,80,0.7)" }}>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-xs font-semibold mb-1" style={{ color: "#9D50FF" }}>Did you know?</p>
              <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.7)" }}>{currentFact.text}</p>
            </div>
          </div>
        </motion.div>
      </AnimatePresence>
